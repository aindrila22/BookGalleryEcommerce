...
var initAdmin = function initAdmin(socket) {
  var orderTableBody = document.querySelector("#orderTable");
  var orders = [];
  var markup;
  ...
  function renderItems(items) {
    ...
    return parsedItems.map(function (menuItem) {
      return "\n  <p>".concat(menuItem.item.bookname, " - ").concat(menuItem.qty, " Pcs</p>\n  ");
    }).join("");
  }
...
var clearCart = document.querySelectorAll("#clear-cart");
...
function clearsCart() {
  axios__WEBPACK_IMPORTED_MODULE_0___default().delete("/cart").then(function (res) {
    new (noty__WEBPACK_IMPORTED_MODULE_2___default())({
      type: "warning",
      timeout: 1000,
...
function updateStatus(orders) {
  ...
  statuses.forEach(function (status) {
    ...
    if (dataProp === orders.status) {
      completed = false;
      time.innerText = moment__WEBPACK_IMPORTED_MODULE_1___default()(order.updatedAt).format("MMMM DD , YYYY  on  hh:mm A");
...
socket.on("orderUpdated", function (data) {
  var updatedOrder = _objectSpread({}, orders);
    ...
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.next = 2;
            return (0,_stripe_stripe_js__WEBPACK_IMPORTED_MODULE_2__.loadStripe)("pk_test_51GtlxpBpkXDIFH0bE02QvluDIQaSDtoYNeY0qXJrSQ6iiWpOI8lbLlMNrsImSKlXNCyyrP4GLc4TvlkPca4QI4xI00gJxfnjYb");
